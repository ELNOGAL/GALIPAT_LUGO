...
"""inherit stock_location for adds functionally for block prodlots locations"""
    ...
    _columns = {
                'usage': fields.selection([('supplier', 'Supplier Location'), ('view', 'View'), ('internal', 'Internal Location'), ('customer', 'Customer Location'), ('inventory', 'Inventory'), ('procurement', 'Procurement'), ('production', 'Production'), ('transit', 'Transit Location for Inter-Companies Transfers'), ('intermediate','Intermediate'), ('elimination', 'Eliminate')], 'Location Type', required=True,
                 help="""* Supplier Location: Virtual location representing the source location for products coming from your suppliers
                       ...
                       \n* Elimination: Virtual Counterpart location for block and eliminate operations
                      """, select = True),
                }
